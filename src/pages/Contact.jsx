      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-10">
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="font-mono text-xs text-[#00f0ff] tracking-[0.2em]">{t('contact.etiket')}</span>
          </div>
          <h1 className="text-5xl font-extrabold tracking-tight mb-6">
            {t('contact.baslik1')} <span className="text-[#00f0ff]">{t('contact.baslik2')}</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#0a1628] border border-[#00f0ff]/10 p-6">
              <div className="font-mono text-xs text-[#3a5a72] mb-3">{t('contact.durum')}</div>
          ...
          <div className="bg-[#0a1628] border border-[#00f0ff]/10 p-8">
            {gonderildi ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-center py-16">
                ...
                <h2 className="text-2xl font-bold mb-3">{t('contact.basari')}</h2>
                <p className="text-[#7a9ab8] mb-8">{t('contact.basari_aciklama')}</p>
                <button
                  onClick={() => {
                    setGonderildi(false);
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={t('contact.isim_placeholder')}
                    required
                ...
                <div>
                  ...
                  <textarea
                    ...
                    value={form.mesaj}
                    onChange={handleChange}
                    placeholder={t('contact.mesaj_placeholder')}
                    required
                    rows={5}
